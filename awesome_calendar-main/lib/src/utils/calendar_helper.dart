...
class CalendarHelper {
  ...
  static DateTime getLastDayOfMonth(DateTime month) {
    ...
    final DateTime firstDayOfNextMonth = DateTime(nextMonth.year, nextMonth.month);
  ...
  static int calculateMaxWeeksNumberMonthly(DateTime startDate, DateTime endDate) {
    ...
    if (monthsNumber == 0) {
      ...
      weeksNumbersMonthly.add(_calculateWeeksNumber(startDate, getLastDayOfMonth(startDate)));
      ...
      for (int i = 1; i <= monthsNumber - 2; i++) {
        ...
        weeksNumbersMonthly.add(_calculateWeeksNumber(firstDateOfMonth, getLastDayOfMonth(firstDateOfMonth)));
      }

      weeksNumbersMonthly.add(_calculateWeeksNumber(getFirstDayOfMonth(endDate), endDate));
  ...
  static int _calculateWeeksNumber(DateTime monthStartDate, DateTime monthEndDate) {
    int rowsNumber = 1;
