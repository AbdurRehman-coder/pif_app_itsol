...
import 'package:pif_flutter/ui/visit_list/widget/visit_card.dart';
import 'package:pif_flutter/ui/visit_list/widget/visit_status.dart';
import 'package:pif_flutter/ui/visit_list/widget/visitor_empty_view.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
          ...
          children: [
            ...
            Expanded(
              child: RefreshIndicator(
                ...
                child: provider.allVisits.value != null && provider.allVisits.value!.isEmpty
                    ? const VisitorEmptyView()
                    : ListView.separated(
                        shrinkWrap: true,
                        itemBuilder: (_, index) {
                          final allVisit = provider.allVisits.value;
                          return VisitCard(
                            notifier: notifier,
                        ...
                        itemCount: provider.allVisits.isLoading ? 3 : provider.allVisits.value!.length,
                      ).shimmerLoading(loading: provider.allVisits.isLoading),
              ),
            ),
          ],
        ),
      ...
      floatingActionButton: FloatingActionButton(
        elevation: 1,
        onPressed: () {
          AppRouter.pushNamed(Routes.inviteVisitorScreen);
        },
        child: Container(
          width: 54.w,
          height: 54.h,
